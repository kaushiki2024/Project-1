       ...
       def __init__(self, master):
              ...
              #========================================================Variables=====================================================================
               ...
               #==========================================================Functions====================================================================
                     ...
                     self.btnDisplay = Button(self.Frame_3, text = 'SHOW', font = ('arial',17,'bold'), width = 8, command = Display)
                     ...
                     self.btnExit = Button(self.Frame_3, text = 'DISPLAY IN TABLE FORM', font = ('arial',17,'bold'), width = 20,command = __show__)
