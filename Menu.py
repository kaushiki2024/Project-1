...
def menu():
       ...
       title_Label = Label(title_Frame, text = 'College Management System', font = ('arial',30,'bold'), bg = 'navajo white')
       ...
       title1_Label = Label(title_Frame, text = 'Buddha Institute of Technology', font = ('arial',30,'bold'), bg = 'navajo white')
       title1_Label.grid(row = 6, column = 0, padx = 150)
       root.mainloop()
